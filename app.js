...
function renderSentiment(payload) {
  ...
  const proxyNotice = sourceQuality === "proxy" ? `<div class="alert-list proxy-source-notice"><article class="alert-item"><div class="inline-between"><strong>代理指标提示</strong>${pill("代理指标", "warning")}</div><span>真实散户情绪/耀眼波动率分钟源暂不可用，当前页面使用市场宽度代理指标，请勿按真实 1 分钟耀眼波动解读。</span></article></div>` : "";
