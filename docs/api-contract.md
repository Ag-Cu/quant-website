...
`/api/v1/strategies/picks` 用于“今日选股”页面。建议支持查询参数：

```text
GET /api/v1/strategies/picks?strategy=momentum&date=2026-05-12
```
...
```text
GET /api/v1/performance?strategy=momentum&from=2025-01-01&to=2026-05-12&benchmark=CSI300
```
